...
def parse_args():
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Examples:\n"
            "  dwdpy -d https://open.spotify.com/track/...\n"
            "  dwdpy --show https://youtu.be/...\n"
            "  dwdpy -d https://soundcloud.com/artist/track\n"
            "  dwdpy --search \"Imagine Dragons Believer\" -d\n"
            "  dwdpy -d --limit 5 https://www.youtube.com/playlist?list=...\n"
            "  dwdpy -d --overwrite -o C:\\MyMusic https://..."
        ),
